...
yuliya = User.create(first_name: "Yuliya", last_name: "Yasenetska", role: "CEO", email: "yuliya.yasentska@flatironschool.com", phone: "7675323333", password_digest: "ukraine", charity_id: bowerymission.id)

howard = User.create(first_name: "Howard", last_name: "DeVennish", role: "Head of Education", email: "howard.devennish@flatironschool.com", phone: "8881234454", password_digest: "literature", charity_id: pencilsofpromise.id)

andrew = User.create(first_name: "Andrew", last_name: "Cohn", role: "Associate Educator", email: "andrew.cohn@flatironschool.com", phone: "1234153206", password_digest: "geeksquad", charity_id: savethechildren.id)

tim = User.create(first_name: "Tim", last_name: "Campbell", role: "Head of Overseas Missions", email: "tim.campbell@flatironschool.com", phone: "6524323459", password_digest: "justmarried", charity_id: savethechildren.id)

#Surpluses

surplus1 = Surplus.create(title: "Chromebooks for Education", description: "Refurbished Chromebooks looking for a new home.", category: "electronics", units: 20, unit_type: "units", available_date: "01/31/2018", corporation_id: google.id, user_id: erica.id)

surplus2 = Surplus.create(title: "Toothpaste", description: "Some fresh Colgate MaxWhite off our production line.", category: "personal care", units: 5, unit_type: "boxes", available_date: "01/31/2018", corporation_id: unilever.id, claimed: true, user_id: connie.id)

surplus3 = Surplus.create(title: "Protein Bars", description: "Chocolate raisin protein bars. There are 20 per box.", category: "Food", units: 10, unit_type: "boxes", available_date: "01/31/2018", corporation_id: nestle.id, user_id: elli.id)

#Needs

need1 = Need.create(title: "Snacks for the children", description: "Some of the children attend after-school programs and they are often hungry. Looking for a healthy snack to stave their hunger.", category: "Food", units: 4, unit_type: "boxes", fulfill_by_date: "02/28/2018", charity_id: savethechildren.id, user_id: andrew.id)

need2 = Need.create(title: "Breakfast foods for our residents", description: "Looking for alternatives to cereal to feed our residents.", category: "Food", units: 7, unit_type: "boxes", fulfill_by_date: "03/01/2018", charity_id: bowerymission.id, user_id: yuliya.id)

need3 = Need.create(title: "New computers for our classrooms", description: "The computers in our classrooms are in desperate need of an upgrade.", category: "electronics", units: 20, unit_type: "units", fulfill_by_date: "03/01/2018", charity_id: pencilsofpromise.id, user_id: howard.id)
